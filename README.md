...
```javascript
import dsemwd from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-dsemwd@esm/index.mjs';
```
The previous example will load the latest bundled code from the esm branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/stats-strided-dsemwd/tags). For example,

```javascript
import dsemwd from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-dsemwd@v0.1.0-esm/index.mjs';
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/stats-strided-dsemwd.svg
[npm-url]: https://npmjs.org/package/@stdlib/stats-strided-dsemwd

[test-image]: https://github.com/stdlib-js/stats-strided-dsemwd/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/stats-strided-dsemwd/actions/workflows/test.yml?query=branch:v0.1.0

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/stats-strided-dsemwd/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/stats-strided-dsemwd?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/stats-strided-dsemwd.svg
[dependencies-url]: https://david-dm.org/stdlib-js/stats-strided-dsemwd/main
...
[deno-url]: https://github.com/stdlib-js/stats-strided-dsemwd/tree/deno
[deno-readme]: https://github.com/stdlib-js/stats-strided-dsemwd/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/stats-strided-dsemwd/tree/umd
[umd-readme]: https://github.com/stdlib-js/stats-strided-dsemwd/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/stats-strided-dsemwd/tree/esm
[esm-readme]: https://github.com/stdlib-js/stats-strided-dsemwd/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/stats-strided-dsemwd/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/stats-strided-dsemwd/main/LICENSE
